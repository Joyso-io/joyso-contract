...
contract('gas analysis', function (accounts) {
    ...
    it("case 1 ", async function () {
        ...
        var inputs = []
        var order1 = await helper.generateOrder(helper.ether(0.005), helper.ether(0.005), helper.ether(0.001),
                                    0x0000001, 20, 10, 0, ORDER_ISBUY, ETHER, token.address, user1, joyso.address)
        Array.prototype.push.apply(inputs, order1)

        var order2 = await helper.generateOrder(helper.ether(0.005), helper.ether(0.005), helper.ether(0.001),
                                    0x0000002, 20, 10, 0, 0, token.address, ETHER, user2, joyso.address)
        Array.prototype.push.apply(inputs, order2)

        var tx = await joyso.matchByAdmin.sendTransaction(inputs, {from: admin, gas: 4700000})
        ...
        var order3 = await helper.generateOrder(helper.ether(0.001), helper.ether(0.001), helper.ether(0.0001), 5, 20, 10, 0, 0, token.address, ETHER, user2, joyso.address)
        Array.prototype.push.apply(inputs, order1)
        Array.prototype.push.apply(inputs, order2)
        ...
        var order4 = await helper.generateOrder(helper.ether(0.001), helper.ether(0.001), helper.ether(0.0001), 9, 20, 10, 0, 0, token.address, ETHER, user2, joyso.address)
        Array.prototype.push.apply(inputs, order1)
        Array.prototype.push.apply(inputs, order2)
        Array.prototype.push.apply(inputs, order3)
        ...
        var order5 = await helper.generateOrder(helper.ether(0.001), helper.ether(0.001), helper.ether(0.0001), 14, 20, 10, 0, 0, token.address, ETHER, user2, joyso.address)
        Array.prototype.push.apply(inputs, order1)
        Array.prototype.push.apply(inputs, order2)
        Array.prototype.push.apply(inputs, order3)
        Array.prototype.push.apply(inputs, order4)
        ...
        var order6 = await helper.generateOrder(helper.ether(0.001), helper.ether(0.001), helper.ether(0.0001), 20, 20, 10, 0, 0, token.address, ETHER, user2, joyso.address)
        Array.prototype.push.apply(inputs, order1)
        Array.prototype.push.apply(inputs, order2)
        Array.prototype.push.apply(inputs, order3)
        Array.prototype.push.apply(inputs, order4)
        ...
        var order7 = await helper.generateOrder(helper.ether(0.001), helper.ether(0.001), helper.ether(0.0001), 27, 20, 10, 0, 0, token.address, ETHER, user2, joyso.address)
        Array.prototype.push.apply(inputs, order1)
        Array.prototype.push.apply(inputs, order2)
        Array.prototype.push.apply(inputs, order3)
        Array.prototype.push.apply(inputs, order4)
        ...
        var order8 = await helper.generateOrder(helper.ether(0.001), helper.ether(0.001), helper.ether(0.0001), 35, 20, 10, 0, 0, token.address, ETHER, user2, joyso.address)
        Array.prototype.push.apply(inputs, order1)
        Array.prototype.push.apply(inputs, order2)
        Array.prototype.push.apply(inputs, order3)
        Array.prototype.push.apply(inputs, order4)
        ...
        var order9 = await helper.generateOrder(helper.ether(0.001), helper.ether(0.001), helper.ether(0.0001), 44, 20, 10, 0, 0, token.address, ETHER, user2, joyso.address)
        Array.prototype.push.apply(inputs, order1)
        Array.prototype.push.apply(inputs, order2)
        Array.prototype.push.apply(inputs, order3)
        Array.prototype.push.apply(inputs, order4)
        ...
        var order10 = await helper.generateOrder(helper.ether(0.001), helper.ether(0.001), helper.ether(0.0001), 54, 20, 10, 0, 0, token.address, ETHER, user2, joyso.address)
        Array.prototype.push.apply(inputs, order1)
        Array.prototype.push.apply(inputs, order2)
        Array.prototype.push.apply(inputs, order3)
        Array.prototype.push.apply(inputs, order4)
